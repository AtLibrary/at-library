...
#  @ignore
#  Сценарий: шаблон {string} заполнен данными из таблицы и сохранён в переменную {string}$
...
#  @ignore
#  Сценарий: перемещещие файла из {string} в {string}
#    И перемещещие файла из "aaa" в "bbbb"

####################################################################################

  Сценарий: установлено значение переменной {string} с текущей датой в формате {string}
    И установлено значение переменной "текущая_дата_минус_час" с текущей датой в формате "yyyy.MM.dd G 'at' HH:mm:ss z"

####################################################################################

  Сценарий: установлено значение переменной {string} с текущей датой минус {int} час/часов в формате {string}
...
####################################################################################
  ...
  Сценарий: установлено значение переменной {string} с текущей датой плюс {int} час/часов в формате {string}$
