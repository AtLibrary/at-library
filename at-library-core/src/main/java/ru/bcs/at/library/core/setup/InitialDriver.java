                    ...
                    switch (deviceNo) {
                        case 0:
                            ...
                            if (AtCoreConfig.app != null) {
                                ...
                                capabilities.setCapability("app", "/Users/user/Desktop/apps/bcs-premier-premier-qaRelease4.apk");
                            }
                            capabilities.setCapability("appActivity", ".ui.BcsActivity");
                        ...
                        case 1:
                            ...
                            if (AtCoreConfig.app != null) {
                                ...
                                capabilities.setCapability("app", "https://portal.testqa.ru/mbnsk/bcs-premier-premier-qaRelease4.apk");
                            }
                            capabilities.setCapability("appActivity", ".ui.BcsActivity");
                            CoreScenario.deviceAvailability[deviceNo] = false;
                            CoreScenario.deviceCases[deviceNo] = scenario.getId();
