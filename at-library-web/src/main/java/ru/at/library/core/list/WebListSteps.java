...
public class WebListSteps {
    ...
    @ParameterType("более|менее")
    public static String moreOrLess(String moreOrLess) {
        return moreOrLess;
    }
     ...
     */
    @И("список элементов {string} отображается на странице")
     ...
     *
     */
    @И("список элементов {string} включает в себя список из таблицы")
     ...
     */
    @И("список элементов {string} равен списку из таблицы")
     ...
     */
    @И("нажатие на элемент с текстом/значением {string} в списке {string}")
     ...
     */
    @И("нажатие на элемент содержащий текст/значение {string} в списке {string}")
     ...
     * @param listName название элемента
     */
    @И("список элементов {string} не отображается на странице")
     ...
     */
    @И("нажатие на {int} элемент в списке {string}")
     ...
     *
     * @return selenideElement возвращает найденный элемент
     */
    @И("нажатие на случайный элемент в списке {string}")
     ...
     */
    @И("выбран любой элемент из списка {string} и его значение сохранено в переменную {string}")
     ...
     */
    @И("текст в \"{int}\" элементе списка {string} равен тексту {string}")
     ...
     */
    @И("список элементов {string} содержит элемент с текстом {string}")
     ...
     */
    @И("список элементов {string} не содержит элемент с текстом {string}")
     ...
     */
    @И("список элементов {string} состоит из {string} элементов")
     ...
     */
    @И("в списке {string} содержится {moreOrLess} {int} элементов/элемента")
