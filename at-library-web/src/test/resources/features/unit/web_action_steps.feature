...
######################################### Установка значения в поле в блоке ############################################
  ...
  Сценарий: в поле "([^"]*)" в блоке "([^"]*)" введено значение "([^"]*)"
    ...
    И в поле "First name input" в блоке "Input example frame" введено значение "action"
    То текст элемента "First name input" в блоке "Input example frame" содержит 6 символа
