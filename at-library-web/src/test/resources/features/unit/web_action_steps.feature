...
####################################################################################
  ...
  Сценарий: выполнен ховер на (?:кнопку|ссылку|поле|блок|чекбокс|радиокнопу|текст|элемент) "([^"]*)"
    Когда совершен переход на страницу "BCS demo аккаунт" по ссылке "url.broker.demo"
    И блок "Навигация" загрузился
    И выполнен ховер на кнопку "Обучение"
    И блок "Обучение" загрузился
    И выполнено нажатие на кнопку "Вебинары/Семинары"
    И текущий URL равен "https://broker.ru/studing"
...
####################################################################################
  ...
  Сценарий: выполнено нажатие на (?:кнопку|ссылку|поле|блок|чекбокс|радиокнопу|текст|элемент) "([^"]*)" в блоке "([^"]*)"
    Когда совершен переход на страницу "BCS Брокер" по ссылке "url.broker"
    Тогда выполнено нажатие на кнопку "Тарифы" в блоке "Навигация"
    И текущий URL равен "https://broker.ru/tariffs"
