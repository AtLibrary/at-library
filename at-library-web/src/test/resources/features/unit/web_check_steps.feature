...
####################################################################################
  ...
  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопа|текст|элемент) "([^"]*)" в блоке "([^"]*)" содержит текст "([^"]*)"
...
####################################################################################
  ...
  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопа|текст|элемент) "([^"]*)" в блоке "([^"]*)" отображается на странице
