...
####################################################################################
  ...
  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопа|текст|элемент) "([^"]*)" отображается на странице
    И поле "ФИО" отображается на странице

####################################################################################

  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопа|текст|элемент) "([^"]*)" отобразился на странице в течение (\d+) (?:секунд|секунды)
    И поле "ФИО" отобразился на странице в течение 5 секунд

####################################################################################

  Сценарий: ожидается исчезновение (?:кнопки|ссылки|поля|чекбокса|радиокнопи|текста|элемента) "([^"]*)"
...
####################################################################################
  ...
  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопа|текст|элемент) "([^"]*)" кликабельно
    Тогда поле "ФИО" кликабельно

####################################################################################

  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопа|текст|элемент) "([^"]*)" кликабельно в течение (\d+) (?:секунд|секунды)
    Тогда поле "ФИО" кликабельно в течение 10 секунд

####################################################################################

  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопа|текст|элемент) "([^"]*)" содержит атрибут "([^"]*)" со значением "(.*)"
    Тогда поле "ФИО" содержит атрибут "type" со значением "text"

####################################################################################

  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопа|текст|элемент) "([^"]*)" содержит класс со значением "(.*)" [HARDCODING]
    Тогда поле "ФИО" содержит класс со значением "ui-form-control"

  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопа|текст|элемент) "([^"]*)" содержит класс со значением "(.*)" [VARIABLE]
    И установлено значение переменной "класс" равным "ui-form-control"
    Тогда поле "ФИО" содержит класс со значением "класс"

  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопа|текст|элемент) "([^"]*)" содержит класс со значением "(.*)" [PROPERTIES]
    Тогда поле "ФИО" содержит класс со значением "css.class.valid"

####################################################################################

  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопа|текст|элемент) "([^"]*)" не содержит класс со значением "(.*)" [HARDCODING]
    Тогда поле "ФИО" не содержит класс со значением "password"


  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопа|текст|элемент) "([^"]*)" не содержит класс со значением "(.*)" [VARIABLE]
    И установлено значение переменной "класс" равным "password"
    Тогда поле "ФИО" не содержит класс со значением "класс"


  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопа|текст|элемент) "([^"]*)" не содержит класс со значением "(.*)" [PROPERTIES]
...
####################################################################################
  ...
  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопа|текст|элемент) "([^"]*)" (?:недоступна|недоступен) для нажатия
