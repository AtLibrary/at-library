...
#TODO Прокрутка iframe
  ...
  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопка|текст|элемент) "([^"]*)" отобразится на странице в течение (\d+) (?:секунд|секунды)
    Когда совершен переход на страницу "Википедия" по ссылке "https://ru.wikipedia.org/"
    И выполнен переход на страницу "Сведения о странице" после нажатия на элемент "Сведения о странице"
    И элемент "Заголовок" отобразится на странице в течение 1 секунды
    И элемент "Заявление о куки" отобразится на странице в течение 1 секунды
